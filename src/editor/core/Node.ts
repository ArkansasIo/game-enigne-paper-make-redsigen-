...
export const NODE_CONSTRUCTOR_KIND = {
	...
	Effect: () => Model.Effect,
	Quest: () => Model.Quest,
	QuestObjective: () => Model.QuestObjective,
	QuestReward: () => Model.QuestReward,
	Recipe: () => Model.Recipe,
	RecipeIngredient: () => Model.RecipeIngredient,
	MapGenPreset: () => Model.MapGenPreset,
...
class Node extends Serializable {
	...
	static createList(list: Model.Base[] | undefined | null, clone = true): Node[] {
	...
	static getCurrentCopyPath(): string {
		return Paths.join(Constants.IS_DESKTOP ? Paths.DIST : LOCAL_FORAGE.ENGINE, Paths.FILE_CURRENT_COPY);
	}
